              ...
              showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: const Text("Сіз топтан шықпақсыз ба?"),
                      actions: [
                        IconButton(
                          onPressed: () {
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (groupName != "") {
                      ...
                      Navigator.of(context).pop();
                      showSnackbar(
                          context, Colors.green, "Топ құрылды");
                    }
                  },
                  style: ElevatedButton.styleFrom(
                      primary: Theme.of(context).primaryColor),
                  child: const Text("Топ құру"),
                )
              ],
            );
          }));
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "Сіз әлі ешқандай топқа қосылған жоқсыз. Топты + батырмасын басып, құрыңыз . Немесе,іздеп көріп , қосылуға сұраныс жіберіңіз",
            textAlign: TextAlign.center,
          )
        ],
      ),
